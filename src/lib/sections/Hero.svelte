<script lang="ts">
	...
	import profileImg1600 from '$lib/assets/profile/profile-w1600.jpg';
	import profileImg800 from '$lib/assets/profile/profile-w800.jpg';
	import { onMount } from 'svelte';
	import { cascade } from 'svelte-typewriter';
	import heroJSON from '../content/hero';
...
>
	{#key visible}
		<div class="max-w-screen-lg mx-auto flex flex-nowrap gap-4 items-center relative isolate">
			...
			<div class="flex-1 relative hidden lg:block">
				...
				<svg id="ring1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 586.65 737.24">
					<defs>
						<style>
							.variant {
								fill: none;
				...
				<svg id="ring2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 587.87 719.7"
					><defs
						><style>
							.primary {
								fill: none;
